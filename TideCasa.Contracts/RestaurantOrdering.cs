...
public sealed record RestaurantMenuItem(string Id, string CategoryId, string Name, string Description, int? PriceCents, string? PriceLabel, bool Available, string? PhotoId = null,
    [property: JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] IReadOnlyList<string>? Ingredients = null);
...
public sealed record OrderItemSelection(string ItemId, int Quantity,
    [property: JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] IReadOnlyList<string>? RemovedIngredients = null,
    [property: JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] string? SpecialRequest = null);
