...
public sealed record RestaurantOperationOrder(RestaurantManagedOrder Order, string? DriverId, IReadOnlyList<string> AllowedActions, bool DeliveryWorkflowEnabled = false);
