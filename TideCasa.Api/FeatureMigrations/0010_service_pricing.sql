-- Preserve paid and pending legacy prices; new purchases defer the service fee for 30 days.
...
CREATE TABLE "tide_service_orders_repriced" (
 ...
 monthly_cents INTEGER NOT NULL CHECK(monthly_cents IN (5000,14900)),
 total_cents INTEGER NOT NULL CHECK((monthly_cents=5000 AND total_cents=initial_cents+monthly_cents) OR (monthly_cents=14900 AND total_cents=initial_cents)),
